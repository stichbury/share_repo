...
# kedro_million_songs documentation build
...
from kedro_million_songs import __version__ as release

# -- Project information -----------------------------------------------------

project = "kedro_million_songs"
author = "Kedro"
...
htmlhelp_basename = "kedro_million_songsdoc"
...
latex_documents = [
    (
        master_doc,
        "kedro_million_songs.tex",
        "kedro_million_songs Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "kedro_million_songs",
        "Project kedro_million_songs codebase.",
        "Nearest-Neighbour",
    )
]
